...
## Generalise for X tanks
## Make operator interface complete and refactor out.
...
##OPTIONAL:
## Genreal network based operator class
...
##Movement:
tank_turn_speed = tank_turn_speed = math.radians(5)
tank_maxspeed = 3.5

shot_speed = 15.0
tank_shots_cooldown = 1.5  #seconds
...
class OperatorActions:
    turn = 0.0 #[-1.0 to 1.0] left to right respectively.
    engine = 0.0 #[-1.0 to 1.0] reverse to full ahead..
    shoot = False
